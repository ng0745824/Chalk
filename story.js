...
console.log('\nOne ' + chalk.yellow('night') + ', in a small ' + chalk.red('Ame') + chalk.white('ri') + chalk.blue('can') 
            ...
            + ' went on, they began telling scary stories.');
console.log('\nOne boy said he had heard an urban legend about an old ' + chalk.gray.bgWhiteBright('graveyard') + ' that was located near the girl’s house.'
...
console.log('\nThe boy who had told the story turned to her and sneered, ' 
            + chalk.bgBlackBright('“It’s all very well to be brave when you’re safe and warm in your own home. \nI think you’d have a different attitude if you actually went to that graveyard.”'));
console.log(chalk.bgBlackBright('\n“It wouldn’t make a difference”') + ', replied the girl haughtily.');
console.log(chalk.bgBlackBright('\n“Ok, then prove it!”') + ' said the boy. '
            + chalk.bgBlackBright('“We’ll all go down to the cemetery and wait outside while you go in and stand on the old '
            + chalk.green('witch’s') + ' grave.”'));
console.log(chalk.bgBlackBright('\n“A grave doesn’t scare me,”') + ' said the girl.' + chalk.bgBlackBright('“I’ll do it right now.”'));
console.log(chalk.bgBlackBright('\n“You’ll have to prove you really did it,”') + ' said the boy.'
            + chalk.bgBlackBright('“Otherwise you might chicken out.”'));
console.log('\nHe took a ' + chalk.red('knife') + ' from the kitchen drawer and handed it to her.');
...
console.log('\nThe group of kids set out for the ' + chalk.gray.bgWhiteBright('graveyard') + ' and when they reached the old ' 
            + chalk.gray('iron gates') + ', they gathered in a circle. All of them stared at the girl.\nShe tried to pretend she wasn’t scared and she hoped they didn’t see her '
            + chalk.cyan('shivering') + ' in fear.');
console.log('\nWith the ' + chalk.red('knife') + ' clutched tightly in her hand, the girl walked through the old ' 
...
console.log('\nShe was filled with terror and flew into a panic.' + chalk.bgBlackBright('“Help!”') + ' she cried. '
            + chalk.bgBlackBright('“She’s got me! She’s got me!”'));
console.log('\nWhen she didn’t come back, her friends began to get worried. After a while, they cautiously entered the ' 
            + chalk.gray.bgWhiteBright('graveyard') + ' to look for her. They found her sprawled across the old woman’s ' 
            + chalk.gray.bgWhiteBright('grave.') + ' She was dead, and her face was ' + chalk.cyanBright('frozen') + ' in a silent scream.');
console.log('\nWithout realizing it, she had plunged the ' + chalk.red('knife') 
            + ' through her skirt and had pinned it to the ground. That was what had been holding her.');
console.log('\nThe poor girl had been so terrified that her ' + chalk.red('heart') + ' gave out and she died of ' + chalk.magenta('fright.'));
